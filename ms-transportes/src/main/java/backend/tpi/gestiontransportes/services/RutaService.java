...
public class RutaService {
    ...
    public Stream<Ruta> listarStream() {
        return rutaRepository.listarStream();
    }

    public Ruta guardar(Ruta nuevo) {
        return rutaRepository.guardar(nuevo);
    }

    public void eliminarPorId(Integer id) {
        rutaRepository.eliminarPorId(id);
    }

    public Optional<Ruta> modificar(Integer id, Ruta nuevo) {
        return rutaRepository.modificar(id, nuevo);
    }

    public boolean existe(Integer id) {
        return rutaRepository.existe(id);
    }
    ...
    private Ruta calcular_ruta_unica(Integer idSolicitud, TarifaDTO tarifa, double distanciaTotal) {
        ...
        // setear tramo (sin camion, con ruta, con nroOrden, sin depoDestino ni origen,
    ...
    private Ruta calcular_ruta_doble(Integer idSolicitud, String origenDireccion, String destinoDireccion,
            TarifaDTO tarifa) {
    ...
    private Ruta calcular_ruta_triple(Integer idSolicitud, String origenDireccion, String destinoDireccion,
        ...
        if (depositoCercanoAlOrigen == null || depositoCercanoAlDestino == null
                || depositoCercanoAlDestino == depositoCercanoAlOrigen) {
    ...
    private BigDecimal calcular_costo_aprox_tramo(double distanciaTramo, TarifaDTO tarifa) {
        // lamar a una fincion calcular_consumo_combustible_aprox que es un promedio del
        // consumo de todos los camiones en actividad
        BigDecimal consumoCombustibleAprox = calcular_consumo_combustible_aprox();
        // de la tarifa que recibo como parametro me quedo con:
        // ** costoBaseKMXVol -- asumo que me pasan la tarifa correcta dado el
        // contenedor de mi solicitud
        ...
        // Costo estimado = distancia * ( costoBaseKMXVolumen + (valor de combustible *
        // consumoCombustibleAproximado ) )

        BigDecimal costoAprox = distanciaBigDecimal
                .multiply(costoBaseKmXVol.add(valorCombustible.multiply(consumoCombustibleAprox)));
    ...
    public BigDecimal calcular_consumo_combustible_aprox() {
        ...
        // igual que la precisión original del campo en la base de datos (precision =
        // 10, scale = 3).
    ...
    // cambiar el estado de la solicitud como "programada"
